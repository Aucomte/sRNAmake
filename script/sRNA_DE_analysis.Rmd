...
#sampleInfoBamFiles <- "/data/projects/rymv_xantho_smallrna/srnamake/output2rpm_filtered/2_mapping_sRNA/bamfile_info.txt"
#genomeGffFile <- "/data/projects/rymv_xantho_smallrna/srnamake/DATA2/annotation/RiceRYMV2.gtf"
#genomeFastaFile <- "/data/projects/rymv_xantho_smallrna/srnamake/output2rpm_filtered/1_cat_ref/all_ref.fa"
#sstackGffFile <- "/data/projects/rymv_xantho_smallrna/srnamake/output2rpm_filtered/4_ShortStack/ShortStack_All_miRNA.gff3"
#ncores <- 6 # snakemake@threads
#outDir <- "/data/projects/rymv_xantho_smallrna/srnamake/output2rpm_filtered/5_sRNA_loci_DE_analysis_test"
#invisible(dir.exists(outDir) || dir.create(path = outDir, mode = "770"))
